...
import json
from Corntranslator.translator import Corntranslator

class CornAgent(PayloadType):
    name = "Corn"
    file_extension = "exe"
    author = "@H0td0gd0g"
    ...
    translation_container = "Corntranslator" # "myPythonTranslation"
    build_parameters = [
        BuildParameter(
            name="output",
    ...
    agent_path = pathlib.Path(".") / "corn"
    agent_icon_path = agent_path / "agent_functions" / "corn.png"
